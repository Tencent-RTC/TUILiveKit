    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          Center(
            child: Text(
              LiveKitLocalizations.of(Global.appContext())!.livekit_link_mic_manager,
      ...
      builder: (BuildContext context, List<SeatInfo> value, Widget? child) {
        return Visibility(
          ...
          child: Container(
            ...
            child: Text(
              "${LiveKitLocalizations.of(Global.appContext())!.livekit_link_mic_up_title}"
        ...
        return ValueListenableBuilder(
          ...
          builder: (BuildContext context, List<SeatInfo> value, Widget? child) {
            return Visibility(
              ...
              child: Container(
                color: LivekitColors.livekitDesignStandardG3Divider,
                height: 7,
              ),
            );
          },
      ...
      builder: (BuildContext context, List<SeatApplication> value, Widget? child) {
        return Visibility(
          ...
          child: Container(
            margin: const EdgeInsets.only(left: 24, top: 20),
            child: Text(
              "${LiveKitLocalizations.of(Global.appContext())!.livekit_link_mic_down_title}"
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(color: LivekitColors.livekitNotStandardRed, width: 1),
                borderRadius: BorderRadius.circular(12),
              ),
              alignment: Alignment.center,
              child: Text(
                LiveKitLocalizations.of(Global.appContext())!.livekit_hang_up,
                style: const TextStyle(color: LivekitColors.livekitNotStandardRed, fontSize: 12),
              ),
            ),
          )
        ],
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    LiveKitLocalizations.of(Global.appContext())!.livekit_accept,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 24,
                  decoration: BoxDecoration(
                    border: Border.all(color: LivekitColors.livekitDesignStandardB1, width: 1),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  alignment: Alignment.center,
                  child: Text(
                    LiveKitLocalizations.of(Global.appContext())!.livekit_reject,
                    style: const TextStyle(color: LivekitColors.livekitDesignStandardB1, fontSize: 12),
                  ),
                ),
              ),
            ],
