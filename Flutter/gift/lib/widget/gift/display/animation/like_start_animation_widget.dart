  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, int showLikeStart, Widget? child) {
        if (showLikeStart != 0) {
          _startWidgetList.add(LikeStarAnimationWidget(key: UniqueKey(), image: imageStarList[Random().nextInt(8)]));
        }
...
class LikeStarAnimationWidgetState extends State<LikeStarAnimationWidget> with TickerProviderStateMixin {
