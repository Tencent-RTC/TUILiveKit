...
import 'package:gift/gift_define.dart';
...
class GiftDisplayController {
  GiftDisplayController(
      {required String roomId, required GiftUser owner, required GiftUser self, bool enablePreloading = false}) {
  ...
  void setGiftCallback({OnReceiveGiftCallback? onReceiveGiftCallback, OnSendGiftCallback? onSendGiftCallback}) {
