...
import 'package:gift/widget/svga_player/path_drawing/dash_path.dart';
...
class SVGAPainter extends CustomPainter {
  ...
  MovieEntity get videoItem => controller.movieEntity!;
  ...
  SVGAPainter(
    ...
    this.clipRect = true,
            ...
            controller.movieEntity != null, 'Invalid SVGAAnimationController!'),
        super(repaint: controller);

  @override
  void paint(Canvas canvas, Size size) {
    int drawSpritesStartTime = DateTime.now().millisecondsSinceEpoch;
    debugPrint("SVGA_DEBUG painter paint start: $drawSpritesStartTime");
    if (controller.canvasNeedsClear) {
      // mark cleared
      controller.canvasNeedsClear = false;
      return;
    }
    if (size.isEmpty || controller.movieEntity == null) return;
    ...
    int drawSpritesEndTime = DateTime.now().millisecondsSinceEpoch;
    int duration = drawSpritesEndTime - drawSpritesStartTime;
    debugPrint("SVGA_DEBUG painter paint end: $drawSpritesEndTime, duration:$duration");
  }
  ...
  bool shouldRepaint(SVGAPainter oldDelegate) {
    ...
    return !(oldDelegate.controller == controller &&
        oldDelegate.controller.movieEntity == controller.movieEntity &&
        oldDelegate.fit == fit &&
