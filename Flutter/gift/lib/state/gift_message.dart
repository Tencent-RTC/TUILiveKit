...
class GiftModel {
  ...
  factory GiftModel.fromJson(Map<String, dynamic> json) {
    return GiftModel(
      ...
      giftNameEn: json['giftName_en'],
      imageUrl: json['imageUrl'],
      animationUrl: json['animationUrl'],
      price: json['price'],
      extInfo: json['extInfo'] != null ? Map<String, String>.from(json['extInfo']) : null,
    );
  }
  ...
  @override
  String toString() {
    return 'Gift{giftId: $giftId, giftName: $giftName, giftNameEn: $giftNameEn, imageUrl: $imageUrl, '
