  ...
  Widget _buildEmojiButton() {
    return GestureDetector(
      ...
      child: ValueListenableBuilder(
        ...
        builder: (BuildContext context, bool value, Widget? child) {
          return Image.asset(
            controller.showEmojiPanel.value ? BarrageImages.keyboardIcon : BarrageImages.emojiIcon,
            width: 24,
            height: 24,
            fit: BoxFit.fill,
  ...
  Widget _buildSendButton(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ButtonStyle(
          backgroundColor: WidgetStateProperty.all(BarrageColors.barrageFlowkitGreen),
