...
class LikeManager {
  ...
  void _initReceiveLikeMessageListener() {
    ...
    isInit = true;
    listener =
        V2TimAdvancedMsgListener(onRecvNewMessage: _onReceiveLikeMessage);
  ...
  _onReceiveLikeMessage(V2TimMessage message) {
    debugPrint(
        "LikeManager receiveBarrage onRecvNewMessage{msgID:${message.msgID},groupID:${message.groupID},"
    ...
    try {
      ...
      debugPrint(
          "LikeManager GiftJson.fromJson jsonDecode Exception:${e.toString()}");
    }
  }
}
