...
import '../../../../widget/svga_player/parser.dart';
import '../../../../widget/svga_player/player.dart';
import '../../../../widget/svga_player/proto/svga_pb.dart';
  ...
  Future<void> _playAnimation() async {
    if (mounted && !animationController.isAnimating && giftQueue.isNotEmpty) {
      ...
      if (svgaUrl != currentSvgaUrl) {
        animationController.movieEntity =
            await _loadSvgaAndParseToMovieEntity(svgaUrl);
