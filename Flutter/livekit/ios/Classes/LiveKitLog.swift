...
class LiveKitLog {
    ...
    static func error(_ moduleName: String, _ file: String, _ line: String, _ messages: String...) {
        log(level: .error, moduleName: moduleName, file: file, line: line, messages)
    }

    static func warn(_ moduleName: String, _ file: String, _ line: String, _ messages: String...) {
        log(level: .warn, moduleName: moduleName, file: file, line: line, messages)
    }

    static func info(_ moduleName: String, _ file: String, _ line: String, _ messages: String...) {
        log(level: .info, moduleName: moduleName, file: file, line: line, messages)
    }

    private static func log(level: LiveKitLogLevel = .info, moduleName: String, file: String, line: String, _ messages: [String]) {
        let apiParams: [String: Any] = [
        LOG_KEY_API: API,
            LOG_KEY_PARAMS: [
        LOG_KEY_PARAMS_LEVEL: level.rawValue,
            LOG_KEY_PARAMS_MESSAGE: messages.joined(),
                LOG_KEY_PARAMS_MODULE: moduleName,
