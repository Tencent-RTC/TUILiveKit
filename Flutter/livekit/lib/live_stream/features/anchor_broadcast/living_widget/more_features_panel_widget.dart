...
class MoreFeaturesPanelWidget extends StatefulWidget {
  ...
  const MoreFeaturesPanelWidget(
      {super.key,
      required this.liveStreamManager,
      required this.liveCoreController});

  @override
  State<MoreFeaturesPanelWidget> createState() =>
      _MoreFeaturesPanelWidgetState();
}
...
extension on _MoreFeaturesPanelWidgetState {
  void _onTapIndex(int index) {
    ...
    switch (item.type) {
      ...
      case FeaturesItemType.mirror:
        liveCoreController
            .enableMirror(!liveCoreController.mediaState.isMirrorEnable);
        break;
      default:
        break;
    }
  ...
  void _initData() {
    list = [
      ...
      FeaturesItem(
          title: LiveKitLocalizations.of(Global.appContext())!
              .common_video_settings_item_mirror,
...
enum FeaturesItemType { beauty, audioEffect, flip, mirror }
