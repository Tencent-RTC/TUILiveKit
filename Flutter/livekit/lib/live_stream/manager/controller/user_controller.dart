...
class UserController extends Controller {
  ...
  Future<void> getAudienceList() async {
    try {
      ...
      if (TUIError.success == userListResult.code && userListResult.data != null) {
        ...
        ErrorHandler.onError(userListResult.code.value(), userListResult.message);
      }
  ...
  Future<void> followUser(String userId) async {
    ...
    try {
      ...
      ErrorHandler.onError(TUIError.errFailed.value(), "followUser failed. userId:$userId");
  ...
  Future<void> unfollowUser(String userId) async {
    ...
    try {
      ...
      ErrorHandler.onError(TUIError.errFailed.value(), "unfollowUser failed. userId:$userId");
  ...
  void onRemoteUserEnterRoom(String roomId, TUIUserInfo userInfo) {
    ...
    userState.enterUserInfo.value = UserInfo.fromTUIUserInfo(userInfo);
