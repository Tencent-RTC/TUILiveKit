...
class MediaController extends Controller {
  ...
  Future<TUIActionCallback> openLocalMicrophone() async {
    ...
    unMuteLocalAudio();
    final result = await liveService.openLocalMicrophone(TUIAudioQuality.audioProfileDefault);
  ...
  Future<TUIActionCallback> unMuteLocalAudio() async {
    final result = await liveService.unMuteLocalAudio();
    if (result.code == TUIError.success) {
  ...
  Future<TUIActionCallback> muteLocalAudio() async {
    final result = await liveService.muteLocalAudio();
    if (result.code == TUIError.success) {
  ...
  Future<TUIActionCallback> openLocalCamera() async {
    ...
    final result = await liveService.openLocalCamera(mediaState.isFrontCamera.value, mediaState.videoQuality.value);
    if (result.code == TUIError.success) {
      _initLivingConfig();
