        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                LiveKitLocalizations.of(Global.appContext())!.live_common_this_live_data,
  ...
  _buildDurationWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_live_duration,
  ...
  _buildViewersWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_live_people_number,
          style: const TextStyle(color: LiveColors.designStandardG5, fontSize: 12),
        ),
      ],
    );
  ...
  _buildMessageWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_message_count,
          style: const TextStyle(color: LiveColors.designStandardG5, fontSize: 12),
        ),
      ],
    );
  ...
  _buildGiftIncomeWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_gift_income,
          style: const TextStyle(color: LiveColors.designStandardG5, fontSize: 12),
        ),
      ],
    );
  ...
  _buildGiftGiversWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_send_gift_people_count,
          style: const TextStyle(color: LiveColors.designStandardG5, fontSize: 12),
        ),
      ],
    );
  ...
  _buildLikesWidget() {
    return Column(
      ...
      children: [
        ...
        2.verticalSpace,
        Text(
          LiveKitLocalizations.of(Global.appContext())!.live_common_like_count,
          style: const TextStyle(color: LiveColors.designStandardG5, fontSize: 12),
        ),
      ],
    );
