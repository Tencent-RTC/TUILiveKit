...
class LiveInfoDetailWidgetState extends BasicState<LiveInfoDetailWidget> {
        ...
        builder: (BuildContext context, String? value, Widget? child) {
          return Text(
            ...
            style: const TextStyle(
                fontSize: 16, fontStyle: FontStyle.normal, color: LiveColors.designStandardG7),
          );
        },
      ),
    );
  ...
  _initLiveIDWidget() {
    return Positioned(
      top: 94,
      child: Text(
        LiveKitLocalizations.of(Global.appContext())!.live_room_info_liveroom_id + liveController.getRoomSate().roomId,
        overflow: TextOverflow.ellipsis,
          ...
          builder: (BuildContext context, value, Widget? child) {
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  _isFollow()
                      ? LiveKitLocalizations.of(Global.appContext())!.live_unfollow_anchor
