...
class RoomController extends Controller {
  ...
  void setLiveCategory(int category) {
    roomState.liveExtraInfo.category.value = category;
  }
  ...
  String getDefaultRoomName() {
    if (roomState.roomName.value != null && roomState.roomName.value!.isNotEmpty) {
      return roomState.roomName.value!;
    } else if (userState.selfInfo.name.value == null || userState.selfInfo.name.value!.isEmpty) {
  ...
  void updateLiveInfo() {
    ...
    liveInfo.isPublicVisible = LiveStreamPrivacyStatus.publicity == roomState.liveExtraInfo.liveMode.value;
    liveInfo.categoryList = [roomState.liveExtraInfo.category.value];
    liveService.setLiveInfo(
      roomState.roomId,
      coverUrl: roomState.coverURL.value,
      categoryList: [roomState.liveExtraInfo.category.value],
      isPublicVisible: LiveStreamPrivacyStatus.publicity == roomState.liveExtraInfo.liveMode.value,
    );
    return;
  }
