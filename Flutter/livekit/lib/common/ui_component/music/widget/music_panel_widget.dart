    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          Center(
            child: Text(
              LiveKitLocalizations.of(Global.appContext())!.livekit_music,
                                    ...
                                    Positioned(
                                      ...
                                      child: Text(
                                        ...
                                        style: const TextStyle(
                                            color: LivekitColors.livekitDesignStandardFlowkitWhite, fontSize: 16),
                                      ),
                                    ),
                                    Positioned(
                                      right: 0,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Image.asset(
                                            LivekitImages.livekitMusicDelete,
                                        ...
                                        child: Container(
                                          ...
                                          child: Image.asset(
                                            musicInfo.isPlaying.value
                                                ? LivekitImages.livekitMusicPause
                                                : LivekitImages.livekitMusicStart,
                                            package: Constants.pluginName,
                                          ),
                                        ),
                                      ),
