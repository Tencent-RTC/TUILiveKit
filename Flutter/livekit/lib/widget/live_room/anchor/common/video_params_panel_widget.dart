    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          Center(
            child: Text(
              LiveKitLocalizations.of(Global.appContext())!.livekit_video_params,
  ...
  _initResolutionWidget() {
    return Container(
      ...
      child: Row(
          ...
          children: [
            Text(
              LiveKitLocalizations.of(Global.appContext())!.livekit_clarity,
              style: const TextStyle(color: LivekitColors.livekitDesignStandardG5, fontSize: 16),
            ),
            GestureDetector(
              onTap: () {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Image.asset(
                      width: 20,
                      height: 20,
                      LivekitImages.livekitDownArrow,
                      package: Constants.pluginName,
                    )
                  ],
                ),
...
extension VideoParamsPanelWidgetStateLogicExtension on VideoParamsPanelWidgetState {
  String _getResolutionShowText() {
    switch (liveController.getMediaState().videoQuality.value) {
      case TUIVideoQuality.videoQuality_360P:
        return LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_360p;
      case TUIVideoQuality.videoQuality_540P:
        return LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_540p;
      case TUIVideoQuality.videoQuality_720P:
        return LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_720p;
      case TUIVideoQuality.videoQuality_1080P:
        return LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_1080p;
    }
  }
  ...
  void _showResolutionSelectWidget() {
    List<ActionSheetModel> list = [
      ActionSheetModel(
          isCenter: true, text: LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_360p, bingData: 0),
      ActionSheetModel(
          isCenter: true, text: LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_540p, bingData: 1),
      ActionSheetModel(
          isCenter: true, text: LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_720p, bingData: 2),
      ActionSheetModel(
          isCenter: true, text: LiveKitLocalizations.of(Global.appContext())!.livekit_resolution_1080p, bingData: 3),
    ];
