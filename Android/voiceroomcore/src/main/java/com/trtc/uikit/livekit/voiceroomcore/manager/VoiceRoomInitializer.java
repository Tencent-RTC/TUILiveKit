...
public final class VoiceRoomInitializer extends ContentProvider {
            ...
            TUIRoomEngine.login(TUIConfig.getAppContext(), TUILogin.getSdkAppId(), TUILogin.getUserId(),
                    TUILogin.getUserSig(), new TUIRoomDefine.ActionCallback() {
                        ...
                        public void onSuccess() {
                            Logger.info("VoiceRoomInitializer", "VoiceRoomInitializer login:[Success]");
                        }

                        @Override
                        public void onError(TUICommonDefine.Error error, String message) {
                            Logger.error("VoiceRoomInitializer", "login:[Error:" + error + ",message:"
                                    + message + "]");
                        }
                    });
        }
