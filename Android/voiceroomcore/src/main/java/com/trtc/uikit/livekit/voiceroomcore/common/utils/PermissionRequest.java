...
public class PermissionRequest {
    ...
    public static void requestMicrophonePermissions(Context context, PermissionCallback callback) {
        StringBuilder title =
                new StringBuilder().append(context.getString(R.string.voiceroomcore_permission_microphone));
        ...
        if (!TextUtils.isEmpty(microphonePermissionsDescription)) {
            ...
            reason.append(context.getString(R.string.voiceroomcore_permission_mic_reason));
        }
        ...
        PermissionRequester.newInstance(permissions)
                .title(context.getString(R.string.voiceroomcore_permission_title, appName, title))
                .description(reason.toString())
                .settingsTip(context.getString(R.string.voiceroomcore_permission_tips, title) + "\n" + reason)
