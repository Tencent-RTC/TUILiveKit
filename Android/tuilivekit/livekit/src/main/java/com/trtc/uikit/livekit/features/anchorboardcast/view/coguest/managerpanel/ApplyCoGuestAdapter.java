...
public class ApplyCoGuestAdapter extends RecyclerView.Adapter<ApplyCoGuestAdapter.ApplyLinkMicViewHolder> {
    ...
    public ApplyCoGuestAdapter(Context context, AnchorManager manager) {
        mContext = context;
        mLiveManage = manager;
    ...
    public void onBindViewHolder(@NonNull ApplyLinkMicViewHolder holder, int position) {
        ...
        holder.textReject.setOnClickListener((view) -> {
            ...
            mCoreView.respondIntraRoomConnection(userInfo.userId, false, new TUIRoomDefine.ActionCallback() {
                @Override
        ...
        holder.textAccept.setOnClickListener((view) -> {
            view.setEnabled(false);
            final TUIRoomDefine.UserInfo userInfo = (TUIRoomDefine.UserInfo) view.getTag();
            mCoreView.respondIntraRoomConnection(userInfo.userId, true, new TUIRoomDefine.ActionCallback() {
                @Override
                public void onSuccess() {
                }
