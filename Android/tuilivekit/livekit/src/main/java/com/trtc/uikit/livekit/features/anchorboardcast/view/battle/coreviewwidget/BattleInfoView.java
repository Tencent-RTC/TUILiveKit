package com.trtc.uikit.livekit.features.anchorboardcast.view.battle.coreviewwidget;
...
public class BattleInfoView extends FrameLayout {
...
//    private final Observer<Boolean>              mBattleResultDisplayObserver = this::onResultDisplay;
    ...
    public BattleInfoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.livekit_battle_info_view, this, true);
...
//    public void init(AnchorStreamingManager manager, LiveCoreView coreView) {
//        mManager = manager;
//        mCoreView = coreView;
//
//        addObserver();
...
//        }
//        setVisibility(VISIBLE);
//        mBattleTimeView.setText(getContext().getString(R.string.common_battle_pk_end));
//    }
//
