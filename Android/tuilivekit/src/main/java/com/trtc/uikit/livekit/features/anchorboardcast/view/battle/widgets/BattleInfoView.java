...
public class BattleInfoView extends BasicView {
    ...
    private void onBattleStart() {
        ...
        if (mCoreState.userState.selfInfo.getValue().userId.equals(mCoreState.roomState.ownerInfo.getValue().userId)
                && !mBattleState.mIsShowingStartView) {
    ...
    private void onResultDisplay(Boolean display) {
        if (Boolean.TRUE.equals(display)) {
            for (BattleUser battleUser : mBattleState.mBattledUsers.getValue()) {
                if (battleUser.userId.equals(mCoreState.roomState.ownerInfo.getValue().userId)) {
