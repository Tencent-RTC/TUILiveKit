...
import com.trtc.uikit.livekit.common.uicomponent.gift.view.TUIImageLoader;
...
public class GiftPanelAdapter extends RecyclerView.Adapter<GiftPanelAdapter.ViewHolder> {
    ...
    private final List<TUIGift> mGiftModelList;
    private OnItemClickListener mOnItemClickListener;
    private int                 mSelectedPosition = RecyclerView.NO_POSITION;

    public GiftPanelAdapter(int pageIndex, List<TUIGift> list, Context context) {
        super();
        mGiftModelList = list;
        mContext = context;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final TUIGift gift = mGiftModelList.get(position);
        TUIImageLoader.loadImage(mContext, holder.mImageGift, gift.imageUrl);
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, TUIGift gift, int position, int pageIndex);
    }
