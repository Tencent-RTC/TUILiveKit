...
public class AudienceSettingsPanelDialog extends PopupDialog implements AudienceManager.AudienceViewListener {

    private final Context         mContext;
    private final AudienceManager mAudienceManager;

    public AudienceSettingsPanelDialog(@NonNull Context context, AudienceManager audienceManager) {
        super(context);
        mContext = context;
    ...
    protected void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.livekit_audience_settings_panel, null);
    ...
    private void initSettingsListView(View view) {
        ...
        AudienceSettingsListAdapter adapter = new AudienceSettingsListAdapter(mContext, mAudienceManager, this);
