...
public class LiveServiceImpl implements ILiveService {
    ...
    public void addLiveBattleManagerObserver(TUILiveBattleManager.Observer observer) {
        LiveStreamLog.info(mTag + " addLiveBattleManagerObserver:[observer:" + observer.hashCode() + "]");
    ...
    public void removeLiveBattleManagerObserver(TUILiveBattleManager.Observer observer) {
        LiveStreamLog.info(mTag + " removeLiveBattleManagerObserver:[observer:" + observer.hashCode() + "]");
    ...
    public void requestBattle(BattleConfig config, List<String> roomIdList, int timeout,
        ...
        LiveStreamLog.info(mTag + " requestBattle:[config:" + new Gson().toJson(config) + ",roomIdList:"
                + roomIdList + ",timeout:" + timeout + "]");
        mTUILiveBattleManager.requestBattle(config, roomIdList, timeout, new BattleRequestCallback() {
            @Override
            public void onSuccess(BattleInfo battleInfo, Map<String, BattleCode> map) {
                LiveStreamLog.info(mTag + " requestBattle:[onSuccess:[battleInfo:" + new Gson().toJson(battleInfo)
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String s) {
                LiveStreamLog.error(mTag + " requestBattle:[onError:[error:" + error + ",s:" + s + "]]");
                if (callback != null) {
                    callback.onError(error, s);
                }
            }
    ...
    @Override
    public void cancelBattleRequest(String battleId, List<String> roomIdList, TUIRoomDefine.ActionCallback callback) {
        LiveStreamLog.info(mTag + " cancelBattleRequest:[battleId:" + battleId + ",roomIdList:" + roomIdList + "]");
        mTUILiveBattleManager.cancelBattleRequest(battleId, roomIdList, new TUIRoomDefine.ActionCallback() {
            @Override
            public void onSuccess() {
                LiveStreamLog.info(mTag + " cancelBattleRequest:[onSuccess]");
                if (callback != null) {
                    callback.onSuccess();
                }
            }
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String s) {
                LiveStreamLog.error(mTag + " cancelBattleRequest:[onError:[error:" + error + ",s:" + s + "]]");
                if (callback != null) {
                    callback.onError(error, s);
                }
            }
    ...
    public void acceptBattle(String battleId, TUIRoomDefine.ActionCallback callback) {
        LiveStreamLog.info(mTag + " acceptBattle:[battleId:" + battleId + "]");
        mTUILiveBattleManager.acceptBattle(battleId, new TUIRoomDefine.ActionCallback() {
            @Override
            public void onSuccess() {
                LiveStreamLog.info(mTag + " acceptBattle:[onSuccess]");
                if (callback != null) {
                    callback.onSuccess();
                }
            }
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String s) {
                LiveStreamLog.error(mTag + " acceptBattle:[onError:[error:" + error + ",s:" + s + "]]");
                if (callback != null) {
                    callback.onError(error, s);
                }
            }
    ...
    public void rejectBattle(String battleId, TUIRoomDefine.ActionCallback callback) {
        LiveStreamLog.info(mTag + " rejectBattle:[battleId:" + battleId + "]");
        mTUILiveBattleManager.rejectBattle(battleId, new TUIRoomDefine.ActionCallback() {
            @Override
            public void onSuccess() {
                LiveStreamLog.info(mTag + " rejectBattle:[onSuccess]");
                if (callback != null) {
                    callback.onSuccess();
                }
            }
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String s) {
                LiveStreamLog.error(mTag + " rejectBattle:[onError:[error:" + error + ",s:" + s + "]]");
                if (callback != null) {
                    callback.onError(error, s);
                }
            }
    ...
    public void exitBattle(String battleId, TUIRoomDefine.ActionCallback callback) {
        LiveStreamLog.info(mTag + " exitBattle:[battleId:" + battleId + "]");
        mTUILiveBattleManager.exitBattle(battleId, new TUIRoomDefine.ActionCallback() {
            @Override
            public void onSuccess() {
                LiveStreamLog.info(mTag + " exitBattle:[onSuccess]");
                if (callback != null) {
                    callback.onSuccess();
                }
            }
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String s) {
                LiveStreamLog.error(mTag + " exitBattle:[onError:[error:" + error + ",s:" + s + "]]");
                if (callback != null) {
                    callback.onError(error, s);
                }
            }
