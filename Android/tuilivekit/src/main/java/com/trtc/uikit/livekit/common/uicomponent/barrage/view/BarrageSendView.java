package com.trtc.uikit.livekit.common.uicomponent.barrage.view;
...
public class BarrageSendView extends Dialog implements IBarrageSendView, OnDecorViewListener.OnKeyboardCallback {
    ...
    private void sendText() {
        ...
        if (TextUtils.isEmpty(message)) {
            ...
            TUIBarrage barrage = createBarrageModel(message);
            sendBarrage(barrage);
            dismiss();
        }
    }
    ...
    @Override
    public void sendBarrage(TUIBarrage barrage) {
        if (barrage == null) {
            return;
        }
    ...
    private TUIBarrage createBarrageModel(String message) {
