...
import com.trtc.uikit.livekit.view.liveroom.TUILiveRoomAnchorFragment;
import com.trtc.uikit.livekit.view.voiceroom.TUIVoiceRoomFragment;

import java.util.Map;

public class TUILiveAnchorFragment extends Fragment implements ITUINotification {
    ...
    public TUILiveAnchorFragment(String liveRoomId, String voiceRoomId) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTUIVoiceRoomFragment = new TUIVoiceRoomFragment(mVoiceRoomId,
    ...
    public void onNotifyEvent(String key, String subKey, Map<String, Object> param) {
        if (EVENT_SUB_KEY_START_LIVE_ROOM.equals(subKey) || EVENT_SUB_KEY_START_VOICE_ROOM.equals(subKey)) {
            ...
            if (EVENT_SUB_KEY_START_LIVE_ROOM.equals(subKey)) {
                transaction.remove(mTUIVoiceRoomFragment);
                transaction.commitNow();
                mTUIVoiceRoomFragment = null;
            } else {
                transaction.remove(mTUILiveRoomAnchorFragment);
                transaction.commitNow();
                mTUILiveRoomAnchorFragment = null;
            }
        }
    }
