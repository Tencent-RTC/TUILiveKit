...
public class TUILiveListDataSource implements LiveListViewDefine.LiveListDataSource {
    private static final LiveKitLogger LOGGER           = LiveKitLogger.getComponentLogger("TUILiveListDataSource");
    private static final int           FETCH_LIST_COUNT = 20;

    @Override
    public void fetchLiveList(LiveListViewDefine.FetchLiveListParam param,
                              LiveListViewDefine.LiveListCallback callback) {
