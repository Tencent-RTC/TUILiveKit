...
public class NetworkInfoState {
    public MutableLiveData<Status>                         videoStatus              = new MutableLiveData<>(Status.Normal);
    public MutableLiveData<Status>                         audioStatus              = new MutableLiveData<>(Status.Normal);
