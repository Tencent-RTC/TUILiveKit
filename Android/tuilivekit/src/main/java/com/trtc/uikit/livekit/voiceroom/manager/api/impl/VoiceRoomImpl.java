...
public class VoiceRoomImpl implements IVoiceRoom {
    ...
    public TUIRoomDefine.Request takeSeat(int seatIndex, int timeout, TUIRoomDefine.RequestCallback callback) {
        LOGGER.info(" takeSeat:[seatIndex:" + seatIndex + ",timeout:" + timeout + "]");
        return mTUIRoomEngine.takeSeat(seatIndex, timeout, new TUIRoomDefine.RequestCallback() {
            @Override
            public void onAccepted(String requestId, String userId) {
                LOGGER.info("takeSeat:[onAccepted:[requestId:" + requestId + ",userId:" + userId + "]]");
                if (callback != null) {
            ...
            public void onRejected(String requestId, String userId, String message) {
                LOGGER.info("takeSeat:[onRejected:[requestId:" + requestId + ",userId:" + userId + "]]");
                if (callback != null) {
            ...
            public void onCancelled(String requestId, String userId) {
                LOGGER.info("takeSeat:[onCancelled:[requestId:" + requestId + ",userId:" + userId + "]]");
                if (callback != null) {
            ...
            public void onTimeout(String requestId, String userId) {
                LOGGER.info("takeSeat:[onTimeout:[requestId:" + requestId + ",userId:" + userId + "]]");
                if (callback != null) {
            ...
            public void onError(String requestId, String userId, TUICommonDefine.Error error, String message) {
                LOGGER.error("takeSeat:onError, [requestId:" + requestId + ",userId:" + userId + ",error:"
    ...
    public void getSeatApplicationList(TUIRoomDefine.RequestListCallback callback) {
        LOGGER.info("getSeatApplicationList:[]");
        mTUIRoomEngine.getSeatApplicationList(new TUIRoomDefine.RequestListCallback() {
            ...
            public void onSuccess(List<TUIRoomDefine.Request> list) {
                LOGGER.info("getSeatApplicationList:[onSuccess:[list:" + new Gson().toJson(list) + "]]");
                if (callback != null) {
                    callback.onSuccess(list);
                }
            }
            ...
            @Override
            public void onError(TUICommonDefine.Error error, String message) {
                LOGGER.error("getSeatApplicationList:[onError:[error:" + error + ",message:" + message
                        + "]]");
                if (callback != null) {
                    callback.onError(error, message);
                }
