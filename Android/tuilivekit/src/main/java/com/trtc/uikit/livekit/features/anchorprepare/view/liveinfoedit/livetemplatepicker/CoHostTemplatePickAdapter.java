...
public class CoHostTemplatePickAdapter extends RecyclerView.Adapter<CoHostTemplatePickAdapter.ImageViewHolder> {
    private final Context              mContext;
    private final List<TemplateType>   mDataList;
    private final OnItemClickListener  mItemClickListener;
    private final AnchorPrepareManager mManager;

    public CoHostTemplatePickAdapter(Context context, AnchorPrepareManager manager, List<TemplateType> dataList,
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        if (mManager.getState().coHostTemplateId.getValue() == data.id) {
