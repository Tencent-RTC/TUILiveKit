...
public class UserManagerDialog extends PopupDialog {
    ...
    public void setSeatIndex(int seatIndex) {
        ...
        if (mSeatInfo != null) {
            updateSeatInfoView();
            mVoiceRoomManager.getUserManager().checkFollowUser(mSeatInfo.userId.getValue());
        }
    }
    ...
    private void addObserver() {
        mVoiceRoomManager.getUserState().followingUserList.observeForever(mFollowingUserObserver);
    ...
    private void initFollowButtonView(View rootView) {
        rootView.findViewById(R.id.fl_follow_panel).setOnClickListener(view -> {
            ...
            if (mVoiceRoomManager.getUserState().followingUserList.getValue().contains(seatUserId)) {
    ...
    private void onFollowingUserChanged(Set<String> followUsers) {
        ...
        if (followUsers.contains(mSeatInfo.userId.getValue())) {
