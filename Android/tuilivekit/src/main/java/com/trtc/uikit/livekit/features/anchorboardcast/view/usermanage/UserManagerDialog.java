...
public class UserManagerDialog extends PopupDialog {
    ...
    public UserManagerDialog(@NonNull Context context, AnchorManager liveStreamManager) {
        super(context);
        mContext = context;
    ...
    public void init(TUIRoomDefine.UserInfo userInfo) {
        ...
        updateView();
        mLiveStreamManager.getUserManager().checkFollowUser(userInfo.userId);
    }
    ...
    private void initFollowButtonView(View rootView) {
        rootView.findViewById(R.id.fl_follow_panel).setOnClickListener(view -> {
            ...
            if (mLiveStreamManager.getUserState().followingUserList.getValue().contains(mUserInfo.userId)) {
    ...
    private void addObserver() {
        mLiveStreamManager.getUserState().followingUserList.observeForever(mFollowingUserObserver);
    ...
    private void removeObserver() {
        mLiveStreamManager.getUserState().followingUserList.removeObserver(mFollowingUserObserver);
