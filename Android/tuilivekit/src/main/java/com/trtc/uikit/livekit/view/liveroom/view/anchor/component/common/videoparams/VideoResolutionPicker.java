...
public class VideoResolutionPicker extends PopupDialog {
    ...
    public VideoResolutionPicker(Context context, LiveController liveController) {
        super(context);
    ...
    private void initListItemClickListener() {
        mListView.setOnItemClickListener((parent, view, position, id) -> {
            mLiveController.getMediaController().updateVideoQuality(getResolutionByPosition(position));
            dismiss();
        });
    }
