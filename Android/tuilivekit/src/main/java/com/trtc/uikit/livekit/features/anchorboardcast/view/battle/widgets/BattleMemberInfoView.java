...
public class BattleMemberInfoView extends BasicView {
    private static final LiveKitLogger LOGGER = LiveKitLogger.getFeaturesLogger("BattleMemberInfoView");
    ...
    public void init(AnchorManager liveStreamManager, String userId) {
        mUserId = userId;
