...
public final class AnchorBattleObserver implements LiveCoreViewDefine.BattleObserver {
    private static final LiveKitLogger LOGGER = LiveKitLogger.getFeaturesLogger("AnchorBattleObserver");

    private final WeakReference<BattleManager> mBattleManagerWeak;

    public AnchorBattleObserver(AnchorManager manager) {
