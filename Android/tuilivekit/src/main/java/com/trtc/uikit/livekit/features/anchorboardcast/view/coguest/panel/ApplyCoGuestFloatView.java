...
public class ApplyCoGuestFloatView extends BasicView {
    ...
    public void init(AnchorManager manager, LiveCoreView liveStream) {
    ...
    private void initRootView() {
        mLayoutRoot.setOnClickListener((view) -> {
            ...
            AnchorCoGuestManageDialog dialog = new AnchorCoGuestManageDialog(mContext, mAnchorManager, mLiveStream);
