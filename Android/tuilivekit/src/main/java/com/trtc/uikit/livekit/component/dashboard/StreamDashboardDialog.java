...
public class StreamDashboardDialog extends PopupDialog {
    ...
    private void bindViewId(View view) {
        ...
        mColorGreen = mContext.getResources().getColor(R.color.livekit_color_dashboard_green);
        mColorPink = mContext.getResources().getColor(R.color.livekit_color_dashboard_pink);
    }
