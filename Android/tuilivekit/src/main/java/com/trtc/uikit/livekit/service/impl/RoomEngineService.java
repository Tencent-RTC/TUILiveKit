...
public class RoomEngineService implements ILiveService {
    ...
    public void addObserver(TUIRoomObserver observer) {
        LiveKitLog.info(mTag + " addObserver:[observer:" + observer + "]");
        mTUIRoomEngine.addObserver(observer);
    }

    @Override
    public void removeObserver(TUIRoomObserver observer) {
        LiveKitLog.info(mTag + " removeObserver:[observer:" + observer + "]");
    ...
    public void setVoiceChangerType(TXAudioEffectManager.TXVoiceChangerType type) {
        LiveKitLog.info(mTag + " setVoiceChangerType:[type:" + type + "]");
    ...
    public void setVoiceReverbType(TXAudioEffectManager.TXVoiceReverbType type) {
        LiveKitLog.info(mTag + " setVoiceReverbType:[type:" + type + "]");
        mTRTCCloud.getAudioEffectManager().setVoiceReverbType(type);
    }

    @Override
    public void enableVoiceEarMonitor(boolean enable) {
        LiveKitLog.info(mTag + " enableVoiceEarMonitor:[enable:" + enable + "]");
        mTRTCCloud.getAudioEffectManager().enableVoiceEarMonitor(enable);
    }

    @Override
    public void stopMusic(int id) {
        LiveKitLog.info(mTag + " stopPlayMusic:[id:" + id + "]");
        mTRTCCloud.getAudioEffectManager().stopPlayMusic(id);
    }

    @Override
    public void startMusic(int id, String path, Float pitch) {
        LiveKitLog.info(mTag + " setMusicPitch:[id:" + id + ",pitch:" + pitch + "]");
        ...
        LiveKitLog.info(mTag + " startPlayMusic:[audioMusicParam:" + new Gson().toJson(audioMusicParam) + "]");
        mTRTCCloud.getAudioEffectManager().startPlayMusic(audioMusicParam);
        mTRTCCloud.getAudioEffectManager().setMusicPitch(id, pitch);
    }

    @Override
    public void setMusicVolume(int volume) {
        LiveKitLog.info(mTag + " setAllMusicVolume:[volume:" + volume + "]");
        mTRTCCloud.getAudioEffectManager().setAllMusicVolume(volume);
    }

    @Override
    public void setVoiceEarMonitorVolume(int volume) {
        LiveKitLog.info(mTag + " setVoiceEarMonitorVolume:[volume:" + volume + "]");
        mTRTCCloud.getAudioEffectManager().setVoiceEarMonitorVolume(volume);
    }

    @Override
    public void setVoiceVolume(int volume) {
        LiveKitLog.info(mTag + " setVoiceCaptureVolume:[volume:" + volume + "]");
    ...
    @Override
    public void setLiveInfo(LiveInfo liveInfo, LiveModifyFlag flag, TUIRoomDefine.ActionCallback callback) {
        LiveKitLog.info((mTag + " setLiveInfo:[liveInfo:" + new Gson().toJson(liveInfo) + ",flag:" + flag + "]"));
        mTUILiveListManager.setLiveInfo(liveInfo, flag, new TUIRoomDefine.ActionCallback() {
            @Override
            public void onSuccess() {
