package com.trtc.uikit.livekit.voiceroom.view.seatview;
...
import com.trtc.uikit.livekit.voiceroom.view.panel.seatactionsheet.SeatActionSheetPanel;
...
public class SeatInfoView extends BasicView {
    ...
    private void updateUserId(String userId) {
        if (TextUtils.isEmpty(userId)) {
            ...
            updateUserVolumeState(mUserState.hasAudioVolumeUserList.get());
        }
    }
    ...
    protected void addObserver() {
        ...
        mUserState.hasAudioVolumeUserList.observe(hasAudioVolumeUserListObserver);
    }
    ...
    protected void removeObserver() {
        ...
        mUserState.hasAudioVolumeUserList.removeObserver(hasAudioVolumeUserListObserver);
    }
}
