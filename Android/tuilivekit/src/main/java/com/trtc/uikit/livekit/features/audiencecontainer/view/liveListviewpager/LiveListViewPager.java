...
public class LiveListViewPager extends FrameLayout {
    ...
    private       LiveListViewPagerAdapter mLiveListViewAdapter;
    ...
    private final Observer<Boolean> mDisableRoomSlidingObserver = this::onRoomSlidingDisable;
    ...
    public void setAdapter(LiveListViewPagerAdapter adapter) {
    ...
    protected void onAttachedToWindow() {
        ...
        AudienceContainerConfig.disableSliding.observeForever(mDisableRoomSlidingObserver);
    }

    @Override
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        AudienceContainerConfig.disableSliding.removeObserver(mDisableRoomSlidingObserver);
    }
    ...
    private void onRoomSlidingDisable(Boolean disable) {
        mViewPager.setUserInputEnabled(!disable);
    }
}
