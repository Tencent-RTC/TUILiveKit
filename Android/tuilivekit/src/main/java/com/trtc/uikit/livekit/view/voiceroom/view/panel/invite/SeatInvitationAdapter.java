...
public class SeatInvitationAdapter extends RecyclerView.Adapter<SeatInvitationAdapter.ViewHolder> {
    ...
    public SeatInvitationAdapter(Context context, LiveController liveController) {
    ...
    private void initData() {
        mData.clear();
        LinkedHashSet<UserState.UserInfo> audienceList = mLiveController.getUserState().userList.get();
