...
public final class TEBeautyProvider extends ContentProvider {
    private static final String TAG = "TEBeautyProvider";

    @Override
    public boolean onCreate() {
        Log.d(TAG, "TEBeautyProvider onCreate");
        TEBeautyExtension extension = new TEBeautyExtension();
