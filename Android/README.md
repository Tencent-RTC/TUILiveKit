...
本文档主要介绍如何快速跑通TUILiveRoom示例工程，体验高质量语音互动，更详细的TUILiveRoom组件接入流程，请点击腾讯云官网文档： [**TUILiveRoom 组件 Android 接入说明** ](https://cloud.tencent.com/document/product/647/43182)
