...
public interface IAudioEffectModel {
     ...
     * @param observer 监听器
     */
    void setMusicObserver(int id, TXAudioEffectManager.TXMusicPlayObserver observer);
