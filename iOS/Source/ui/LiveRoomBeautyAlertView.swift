...
public class LiveRoomBeautyIntensityView: UIView {
    ...
    @objc public func sliderValueChange() {
    ...
    public func setSlider(minValue: Float, maxValue: Float) {
...
public class LiveRoomBeautyAlertView: LiveRoomAlertContentView {
    ...
    public override func bindInteraction() {
        ...
        beautyCollectionView.register(LiveRoomBeautyCell.self, forCellWithReuseIdentifier: "LiveRoomBeautyCell")
        beautyTypeCollectionView.register(LiveRoomBeautyTypeCell.self, forCellWithReuseIdentifier: "LiveRoomBeautyTypeCell")
...
extension LiveRoomBeautyAlertView {
...
extension LiveRoomBeautyAlertView: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == beautyCollectionView {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LiveRoomBeautyCell", for: indexPath)
            if let scell = cell as? LiveRoomBeautyCell {
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LiveRoomBeautyTypeCell", for: indexPath)
            if let scell = cell as? LiveRoomBeautyTypeCell {
...
extension LiveRoomBeautyAlertView: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if collectionView == beautyCollectionView {
            ...
            let pkg = viewModel.dataSource[indexPath.item]
            var width = pkg.title.width(fromFont: LiveRoomBeautyTypeCell.titleLabelFont)
            if width < 32 {
                width = 32
            }
            else if width > 120 {
...
public class LiveRoomBeautyCell: UICollectionViewCell {
    
    public var model: TCBeautyBaseItem? {
        didSet {
...
public class LiveRoomBeautyTypeCell: UICollectionViewCell {
