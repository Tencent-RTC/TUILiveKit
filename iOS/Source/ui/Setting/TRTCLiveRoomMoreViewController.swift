...
public class TRTCLiveRoomMoreViewController: UIViewController, PresentBottomVCProtocol {
...
public class PresentBottom:UIPresentationController {
    ...
    public override init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?) {
        ...
        if case let vc as TRTCLiveRoomMoreViewController = presentedViewController {
...
extension UIViewController: UIViewControllerTransitioningDelegate {
    ...
    public func presentBottom(_ vc: TRTCLiveRoomMoreViewController ) {
