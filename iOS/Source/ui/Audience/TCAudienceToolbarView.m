...
- (void)initUI:(BOOL)linkmic {
    ...
    [_closeBtn setBackgroundImage:[UIImage imageNamed:@"live_exit" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_likeBtn setImage:[UIImage imageNamed:@"like_hover" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
