...
- (UIView *)creatAnimateView {
    ...
    UIImage *image = [UIImage imageNamed:@"Barrage" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil];
...
- (UIView *)resetViewFrame:(UIView *)aView msg:(TCMsgModel *)msgModel {
    ...
    if (viewArray.count >= 3) {
        ...
        [headImageView sd_setImageWithURL:[NSURL URLWithString:[TCUtil transImageURL2HttpsURL:msgModel.userHeadImageUrl]] placeholderImage:[UIImage imageNamed:@"default_user" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
...
- (NSAttributedString *)getAttributedUserMsgFromModel:(TCMsgModel *)msgModel {
    ...
    [attribute addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:12] range:NSMakeRange(0,attribute.length)];
    [attribute addAttribute:NSForegroundColorAttributeName value:[[UIColor alloc] initWithHex:@"0x89eede"] range:NSMakeRange(0,userMsg.length)];;
    return attribute;
}
@end
