...
+ (NSAttributedString *)getAttributedStringFromModel:(TCMsgModel *)msgModel {
     _arryColor = [[NSMutableArray alloc] initWithObjects:
                   [[UIColor alloc] initWithHex:@"0x1fbcb6"],
                   [[UIColor alloc] initWithHex:@"0x2b7de2"],
                   [[UIColor alloc] initWithHex:@"0xff7906"],nil];
    ...
    if (msgModel.msgType == TCMsgModelType_NormalMsg || msgModel.msgType == TCMsgModelType_DanmaMsg) {
        ...
        NSMutableAttributedString *msgShow = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@ %@%@", LiveRoomLocalize (@"Demo.TRTC.LiveRoom.notice"), msgModel.userName, msgModel.userMsg]];
...
- (void)initUI {
    ...
    [_hostImage sd_setImageWithURL:[NSURL URLWithString:[TCUtil transImageURL2HttpsURL:_hostFaceUrl]] placeholderImage:[UIImage imageNamed:@"default_user" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
    ...
    if (_isHost) {
        ...
        _durationImage.image = [UIImage imageNamed:@"dot" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil];
...
- (void)refreshWithModel:(TRTCLiveUserInfo *)msgModel {
    [_imageView sd_setImageWithURL:[NSURL URLWithString:[TCUtil transImageURL2HttpsURL:msgModel.avatarURL]] placeholderImage:[UIImage imageNamed:@"face" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
}
@end
