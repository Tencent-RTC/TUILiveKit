...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _audioEffectArry = [NSMutableArray arrayWithObjects:
                            ...
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.ktv"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.room"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.hall"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.muffled"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.sonorous"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.metal"),
                            LiveRoomLocalize(@"Demo.TRTC.LiveRoom.magnetic"), nil];
        ...
        _audioEffectArry2 = [NSMutableArray arrayWithObjects:
                             LiveRoomLocalize(@"Demo.TRTC.LiveRoom.originalsound"),
                             LiveRoomLocalize(@"Demo.TRTC.LiveRoom.badboy"),
...
//    float icon_count = 6;
    ...
    [_btnChat setBackgroundImage: [UIImage imageNamed:@"comment" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_btnCamera setImage:[UIImage imageNamed:@"live_camera" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_btnPK setImage:[UIImage imageNamed:@"live_pk_start" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_btnBeauty setImage:[UIImage imageNamed:@"live_beauty" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_btnMusic setImage:[UIImage imageNamed:@"music_icon" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    //pk view
    _pkView = [[UIImageView alloc] initWithImage: [UIImage imageNamed:@"PK" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
    ...
    [_closeBtn setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.stop") forState:UIControlStateNormal];
    ...
    [_msgTableView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(_btnChat.mas_top).offset(-MSG_TABLEVIEW_BOTTOM_SPACE);
        make.width.mas_equalTo(MSG_TABLEVIEW_WIDTH);
        make.height.mas_equalTo(MSG_TABLEVIEW_HEIGHT);
    ...
    [_bulletViewOne mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(_msgTableView.mas_top).offset(-MSG_UI_SPACE);
        make.width.mas_equalTo(SCREEN_WIDTH);
        make.height.mas_equalTo(MSG_BULLETVIEW_HEIGHT);
    }];
    ...
    [_bulletViewTwo mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.equalTo(self);
        make.bottom.equalTo(_msgTableView.mas_top);
        make.width.mas_equalTo(SCREEN_WIDTH);
        make.height.mas_equalTo(MSG_BULLETVIEW_HEIGHT);
    }];
    ...
    imageView.image = [UIImage imageNamed:@"input_comment" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil];
    ...
    [bulletBtn setImage:[UIImage imageNamed:@"Switch_OFF" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [bulletBtn setImage:[UIImage imageNamed:@"Switch_ON" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
    ...
    [sendBtn setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.send") forState:UIControlStateNormal];
    [sendBtn.titleLabel setFont:[UIFont systemFontOfSize:16]];
    [sendBtn setTitleColor:[[UIColor alloc] initWithHex:@"0x0ACCAC"] forState:UIControlStateNormal];
    ...
    UIImageView *msgInputFeildLine1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"vertical_line" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
    msgInputFeildLine1.frame = CGRectMake(bulletBtn.right + 10, sendBtn.y, 1, MSG_TEXT_SEND_FEILD_HEIGHT);
    
    UIImageView *msgInputFeildLine2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"vertical_line" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil]];
    ...
    _msgInputFeild.placeholder = LiveRoomLocalize(@"Demo.TRTC.LiveRoom.saysomething");
...
//    _vMusicPanel.delegate = self;
    ...
    _btnSelectBGM.layer.borderColor = [[UIColor alloc] initWithHex:@"0x0ACCAC"].CGColor;
    [_btnSelectBGM.layer setMasksToBounds:YES];
    [_btnSelectBGM.layer setCornerRadius:6];
    [_btnSelectBGM.layer setBorderWidth:1.0];
    [_btnSelectBGM setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.accompaniment") forState:UIControlStateNormal];
    [_btnSelectBGM setTitleColor:[[UIColor alloc] initWithHex:@"0x0ACCAC"] forState:UIControlStateNormal];
    ...
    _btnStopBGM.layer.borderColor = [[UIColor alloc] initWithHex:@"0x0ACCAC"].CGColor;;
    [_btnStopBGM setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.end") forState:UIControlStateNormal];
    [_btnStopBGM.layer setMasksToBounds:YES];
    [_btnStopBGM.layer setCornerRadius:6];
    [_btnStopBGM.layer setBorderWidth:1.0];
    [_btnStopBGM setTitleColor: [[UIColor alloc] initWithHex:@"0x0ACCAC"] forState:UIControlStateNormal];
    ...
    [_labVolumeForBGM setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.accompanimentvolume")];
    [_labVolumeForBGM setFont:[UIFont systemFontOfSize:12.f]];
    _labVolumeForBGM.textColor = [[UIColor alloc] initWithHex:@"0x0ACCAC"];
    ...
    [_sldVolumeForBGM setThumbImage:[UIImage imageNamed:@"slider" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldVolumeForBGM setMinimumTrackImage:[UIImage imageNamed:@"green" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldVolumeForBGM setMaximumTrackImage:[UIImage imageNamed:@"gray" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_labVolumeForVoice setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.vocalvolume")];
    [_labVolumeForVoice setFont:[UIFont systemFontOfSize:12.f]];
    _labVolumeForVoice.textColor = [[UIColor alloc] initWithHex:@"0x0ACCAC"];
    ...
    [_sldVolumeForVoice setThumbImage:[UIImage imageNamed:@"slider" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldVolumeForVoice setMinimumTrackImage:[UIImage imageNamed:@"green" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldVolumeForVoice setMaximumTrackImage:[UIImage imageNamed:@"gray" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [_labPositionForBGM setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.accompanimentfastforward")];
    [_labPositionForBGM setFont:[UIFont systemFontOfSize:12.f]];
    _labPositionForBGM.textColor = [[UIColor alloc] initWithHex:@"0x0ACCAC"];
    ...
    [_sldPositionForBGM setThumbImage:[UIImage imageNamed:@"slider" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldPositionForBGM setMinimumTrackImage:[UIImage imageNamed:@"green" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [_sldPositionForBGM setMaximumTrackImage:[UIImage imageNamed:@"gray" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    for (int i=0; i<_audioEffectArry.count; ++i) {
        ...
        [btn setBackgroundImage:[UIImage imageNamed:@"unselected" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    for (int i=0; i<_audioEffectArry2.count; ++i) {
        ...
        [btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateSelected];
        [btn setBackgroundImage:[UIImage imageNamed:@"round-unselected" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
        [btn.layer setMasksToBounds:YES];
        [btn.layer setCornerRadius:btn.height/2];
...
- (void)changeButtonStopPK {
    ...
    [_closeBtn setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.endpk") forState:UIControlStateNormal];
...
- (void)selectEffect:(UIButton *)button {
    ...
    button.selected = YES;
    [button setBackgroundImage:[UIImage imageNamed:@"round-selected" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
- (void)showLikeHeartStartRect:(CGRect)frame {
    ...
    imageView.image = [[UIImage imageNamed:@"img_like" inBundle:LiveRoomBundle() compatibleWithTraitCollection:nil] imageWithTintColor:[UIColor randomFlatDarkColor]];
...
- (void)closeVC {
    _closeAlert = [UIAlertController alertControllerWithTitle:nil message:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.interactioninprogress") preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.cancel") style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action){
    }];
    __weak typeof(self)weakSelf = self;
    UIAlertAction *otherAction = [UIAlertAction actionWithTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.confirm") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action){
        __strong __typeof(weakSelf)strongSelf = weakSelf;
        if (strongSelf.delegate) {
            [strongSelf.topView pauseLive];
            [strongSelf->_bulletViewOne stopAnimation];
            [strongSelf->_bulletViewTwo stopAnimation];
            [[NSNotificationCenter defaultCenter] removeObserver:self];
            
            [strongSelf.delegate closeRTMP];
            // 直播过程中退出时展示统计信息
            strongSelf->_resultView = [[TCPushShowResultView alloc] initWithFrame:CGRectMake(
                                                                                           ...
                                                                                           222)
                                                                     resultData:strongSelf->_topView backHomepage:^{
                [weakSelf.delegate closeVC];
            }];
            
            strongSelf->_clearView = [[UIView alloc] initWithFrame:weakSelf.bounds];
            strongSelf->_clearView.backgroundColor = [UIColor blackColor];
            strongSelf->_clearView.alpha = 0.3;
            [strongSelf addSubview:strongSelf->_clearView];
            [strongSelf addSubview:strongSelf->_resultView];
        }
    }];
    [_closeAlert addAction:cancelAction];
    [_closeAlert addAction:otherAction];
    [self.anchorViewController presentViewController:_closeAlert animated:true completion:nil];
}
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField{
    ...
    if (textMsg.length <= 0) {
        textField.text = @"";
        [HUDHelper alert:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.messagecantbeempty")];
        return YES;
    }
...
- (void)initUI {
    ...
    [_titleLabel setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.interactionitsover")];
    ...
    [_durationTipLabel setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.interactionduration")];
    ...
    [_viewerCountTipLabel setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.viewers")];
    ...
    [_praiseTipLabel setText:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.numberoflikes")];
    ...
    [_backBtn setTitle:LiveRoomLocalize(@"Demo.TRTC.LiveRoom.back") forState:UIControlStateNormal];
