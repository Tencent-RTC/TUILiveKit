...
struct AnchorAlertInfo {
    ...
    let cancelClosure: AnchorAlertButtonClickClosure?
    let defaultClosure: AnchorAlertButtonClickClosure
    
    init(description: String, 
         imagePath: String?,
         cancelButtonInfo: (title: String, titleColor: UIColor)? = nil,
         defaultButtonInfo: (title: String, titleColor: UIColor) = (.confirmText, .b1),
         cancelClosure: AnchorAlertButtonClickClosure?,
         defaultClosure: @escaping AnchorAlertButtonClickClosure) {
...
extension AnchorAlertInfo: Equatable {
    static func == (lhs: AnchorAlertInfo, rhs: AnchorAlertInfo) -> Bool {
        return lhs.description == rhs.description
    }
}

class AnchorAlertPanel: UIView {
    private let alertInfo: AnchorAlertInfo
    ...
    init(alertInfo: AnchorAlertInfo) {
