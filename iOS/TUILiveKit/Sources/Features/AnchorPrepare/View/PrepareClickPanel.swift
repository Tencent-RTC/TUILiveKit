...
struct PrepareFeatureItemDesignConfig {
    var type: PrepareFeatureItemType = .singleImage
...
class PrepareFeatureItem {
    ...
    var actionClosure: ((PrepareFeatureItemButton)->Void)?
    ...
    init(normalTitle: String? = nil,
         ...
         designConfig: PrepareFeatureItemDesignConfig = PrepareFeatureItemDesignConfig(),
         actionClosure: ((PrepareFeatureItemButton)->Void)? = nil) {
...
class PrepareFeatureClickPanelModel {
    let id: UUID = UUID()
...
extension PrepareFeatureClickPanelModel: Equatable {
    static func == (lhs: PrepareFeatureClickPanelModel, rhs: PrepareFeatureClickPanelModel) -> Bool {
        return lhs.id == rhs.id
    }
}

class PrepareFeatureItemButton: UIControl {
    var item: PrepareFeatureItem
    init(item: PrepareFeatureItem) {
        self.item = item
...
class PrepareFeatureClickPanel: UIView {
    var model: PrepareFeatureClickPanelModel
    init(model: PrepareFeatureClickPanelModel) {
        self.model = model
        super.init(frame: .zero)
    }
    ...
    func setView() {
        var leftButton: PrepareFeatureItemButton?
    ...
    func createFeatureItemButton(item: PrepareFeatureItem) -> PrepareFeatureItemButton {
        let view = PrepareFeatureItemButton(item: item)
...
extension PrepareFeatureClickPanel {
    @objc func itemClick(_ sender: PrepareFeatureItemButton) {
