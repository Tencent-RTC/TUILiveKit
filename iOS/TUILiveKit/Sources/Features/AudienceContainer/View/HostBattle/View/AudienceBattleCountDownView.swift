//
//  AudienceBattleCountDownView.swift
//  TUILiveKit
//
...
class AudienceBattleCountDownView: UIView {
    ...
    private let manager: AudienceBattleManager
    
    init(countdownTime: TimeInterval, manager: AudienceBattleManager, coreView: LiveCoreView) {
    ...
    lazy var countdownTimer = AudienceCountdownTimer(seconds: countdownTime, onTick: { [weak self] remainingSeconds in
    ...
    private lazy var backgroundView: AudienceBattleCountDownBackgroundView = {
        let view = AudienceBattleCountDownBackgroundView()
