...
struct AlertInfo {
    ...
    let cancelClosure: AlertButtonClickClosure?
    let defaultClosure: AlertButtonClickClosure
    
    init(description: String, 
         imagePath: String?,
         cancelButtonInfo: (title: String, titleColor: UIColor)? = nil,
         defaultButtonInfo: (title: String, titleColor: UIColor) = (.confirmText, .b1),
         cancelClosure: AlertButtonClickClosure?,
         defaultClosure: @escaping AlertButtonClickClosure) {
