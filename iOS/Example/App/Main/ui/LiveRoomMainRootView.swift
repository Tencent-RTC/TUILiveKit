...
protocol LiveRoomMainRootViewDelegate: NSObject {
    func enterRoom(roomId: String)
    func createRoom()
}

class LiveRoomMainRootView: UIView {
    ...
    weak var delegate: LiveRoomMainRootViewDelegate? = nil
...
extension LiveRoomMainRootView {
...
private extension String {
    static let roomNumberText = TRTCLiveRoomLocalize("Demo.TRTC.LiveRoom.roomNumber")
    static let enterRoomNumberText = TRTCLiveRoomLocalize("Demo.TRTC.LiveRoom.enterRoomNumber")
    static let enterRoomText = TRTCLiveRoomLocalize("Demo.TRTC.LiveRoom.enterRoom")
    static let createRoomText = TRTCLiveRoomLocalize("Demo.TRTC.LiveRoom.createRoom")
}
