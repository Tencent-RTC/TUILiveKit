...
extension UserAgreementViewController {
    func setupUI() {
        self.title = TUILiveKitAppLocalize("TUILiveKitApp.termsandconditions")
        ...
        agreeBtn.setTitle(TUILiveKitAppLocalize("TUILiveKitApp.agree"), for: .normal)
        ...
        unAgreeBtn.setTitle(TUILiveKitAppLocalize("TUILiveKitApp.disagree"), for: .normal)
