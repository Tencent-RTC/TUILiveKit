...
class KTVRoomViewController: UIViewController {
...
// MARK: - Private
extension KTVRoomViewController {
...
extension KTVRoomViewController {
    ...
    @objc private func goLiveClick() {
        let voiceRoomId = LiveIdentityGenerator.shared.generateId(TUILogin.getUserID() ?? "", type: .ktv)
        KTVRoomKit.createInstance().createRoom(roomId: voiceRoomId)
    }
}
